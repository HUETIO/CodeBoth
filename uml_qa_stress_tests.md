...
## Nota sobre carga/estrés
Estas pruebas ejercen la interfaz en bucles para detectar bloqueos, desincronización de estado y problemas de rendimiento en el frontend.
Para carga a nivel API, se recomienda usar K6/JMeter en un flujo similar (login, fetch movies, chat).
